...
public interface CredentialsDAO {
	...
	String createCredentials(final CredentialsBean credentials);

	int deleteCredentials(final ArrayList<String> id);

	ArrayList<CredentialsBean> findAll();

	CredentialsBean findByID(final String id);

	boolean updateCredentials(final CredentialsBean credentials);
